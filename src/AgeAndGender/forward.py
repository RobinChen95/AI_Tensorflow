    ...
    with tf.variable_scope("forward", "forward", [x]) as scope:
        with tf.contrib.slim.arg_scope(
            ...
            with tf.contrib.slim.arg_scope(
                ...
                #layer1
                conv1 = convolution2d(x, 96, [7,7], [4, 4], padding='VALID', biases_initializer=tf.constant_initializer(0.), scope='conv1')
                ...
                #layer3 
                conv3 = convolution2d(pool2, 384, [3, 3], [1, 1], biases_initializer=tf.constant_initializer(0.), padding='SAME', scope='conv3')
